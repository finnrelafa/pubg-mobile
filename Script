gg.setVisible(false)
gg.toast("⌛️Loading Script.…")
gg.setRanges(gg.REGION_C_ALLOC | gg.REGION_ANONYMOUS | gg.REGION_JAVA_HEAP | gg.REGION_PPSSPP | gg.REGION_C_BSS | gg.REGION_C_DATA | gg.REGION_C_HEAP)
gg.getResults(5000)
...
function HOME()
  MN = gg.choice({
"✧ ❴Menu❵ Bypass Sealing Game",
    "✧ ❴Menu❵  Wallhack & Colour",
    "✧ ❴Menu❵ Strength",
    "✧ ❴Menu❵ Other",
    "✧ ❴Menu❵ Weapon Hack",
    "✧ ❴Menu❵ Skin Weapon",
    "✧ ❴Menu❵ Reduce Risk Ban",
    "📧 Contact Person",
    "🔚Exit"
  }, nil, "▰ ▱ PUBG MOBILE HACK ▰ ▱ ")
  if MN == nil then
  else
  if MN ==  1 then BYPAZZ() end
    if MN == 2 then
      WHC()
    end
    if MN == 3 then
...
gg.searchNumber("1.1F;1.4F:3::1", gg.TYPE_DOUBLE, false, gg.SIGN_EQUAL, 0, -1)
gg.searchNumber("1.1D;1.4D:2::10", gg.TYPE_DOUBLE, false, gg.SIGN_EQUAL, 0, -1)
 gg.toast("BYPASS 💯% SUCCESS Happy Cheating")
end

function BYPAZZ()
GH = gg.choice({"Bypass V1 [Logo Tencent]","Bypass V2[Logo Tencent]","🔙Back"},nil,'Function Bypass')
if GH == 1 then bypass2() end
if GH == 2 then bypass() end
if GH == 3 then HOME() end
end
...
gg.searchNumber("1", 127, false, 536870912, 0, -1)
gg.searchNumber("1", 127, false, 536870912, 0, -1)
gg.toast("Bypass V1 Sucess")
gg.clearResults()
end

function CP()
GC = gg.alert("Youtube Channel: Finn Relafa\n\nFacebook: Finn Relafa\n\nTelegram : t.me/Finn264","🔙Back")
if GC == 1 then HOME()
end
end
...
function flashVIP()
  ...
  gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
  gg.searchNumber("1;120;0.5;50;100;60,000.0", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
  gg.searchNumber("1", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
  CLOSE()
end
function speedVIP()
...
gg.setRanges(gg.REGION_C_ALLOC)
  gg.searchNumber("1954047316D;1970037078D", gg.TYPE_DWORD, false, gg.SIGN_EQUAL, 0, -1)
    ...
    gg.toast(" Anti Report Sucess")
    end
    
    function AR2()
    gg.alert("Use Every Play Time")
  gg.setRanges(gg.REGION_BAD)
  gg.clearResults()
...
function BAT1()
  ...
  gg.clearResults()
  gg.toast("•°Process!°•")
  os.remove("/mnt/sdcard/Android/data/com.tencent.ig/cache/GCloud.ini")
  os.remove("/mnt/sdcard/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Logs")
...
function BAT2()
  ...
  gg.getResults(10)
  gg.editAll("0", gg.TYPE_FLOAT)
  gg.toast("Super anti-sealing is successfully opened")
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC)
  gg.searchNumber("909391408;808923191::8", gg.TYPE_DWORD)
  if gg.getResultCount() == 0 then
    gg.toast("Authentication failure")
  else
    gg.searchNumber("909391408", gg.TYPE_DWORD)
    gg.getResults(999)
    gg.editAll("1089886885", gg.TYPE_DWORD)
    gg.toast("Sustained seal authentication")
  end
  gg.clearResults()
  gg.setRanges(gg.REGION_C_ALLOC)
  gg.searchNumber("1.4349296e-41;1.4012985e-45;5.6051939e-45;2.986167e-42::", gg.TYPE_FLOAT)
  if gg.getResultCount() == 0 then
    gg.toast("Hall seal search failed")
  else
    gg.searchNumber("2.986167e-42", gg.TYPE_FLOAT)
    gg.getResults(999)
    gg.toast("Hall seals manually modified to freeze 0")
    gg.setVisible(true)
    os.exit()
  end
end
...
function BloodColor()
  gg.setRanges(gg.REGION_BAD)
  gg.searchNumber("1.6815582e-44;1.1204998e-19;0.5;3", gg.TYPE_FLOAT, false, gg.SIGN_FUZZY_EQUAL, 0, -1)
...
function MTK()
  gg.setRanges(gg.REGION_C_ALLOC)
  gg.searchNumber("640.0;360;0.5;0;640;360;0.5;12000;0.27913400531;0.56855899096::", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
...
function MTK2()
  gg.setRanges(gg.REGION_C_ALLOC)
  gg.searchNumber("0.5;360;640;1;1;1;-640;360::", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
  gg.searchNumber("0.5", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
  var = gg.getResults(20)
  gg.editAll("0", gg.TYPE_FLOAT)
  var = gg.getResults(100)
...
function MTK3()
  gg.setRanges(gg.REGION_C_ALLOC)
  gg.searchNumber("3.5873241e-43;0.5;360;360;760;760;1;1;1;1;1;1;1::", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
  gg.searchNumber("0.5", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
  var = gg.getResults(20)
  gg.editAll("0", gg.TYPE_FLOAT)
  var = gg.getResults(100)
...
function CLOSE()
gg.toast("Thanks For Using This Script")
print('Chat me if I find a bug in this script\n🇲🇨t.me/finn264 🇲🇨')
gg.skipRestoreState()
  os.exit()
  gg.setVisible(true)
end

HM = gg.alert("==========================\n.     [⏺️HACK SCRIPT PUBGM⏺️]\n   🔽🔽Click Yes For Bypass!!!🔽🔽\n==========================","[Bypass V1]","[Bypass V2]","[No]")
if HM == 1 then 
bypass2() 
end
if HM == 2 then Bypass()
